...
import { MENU_FOOTER_OPTIONS } from "../constants";
      ...
      <div className="flex basis-[60%] justify-end gap-x-5 items-center">
        ...
        <div className="_menu_container relative">
          ...
          <div
            className={`${
              active ? "block" : "hidden"
            } max-h-[90vh] overflow-auto border-[1px] w-64 text-sm text-gray-500 absolute top-[120%] right-0 rounded-md z-10 bg-white`}
          >
            <ul className="flex flex-col gap-y-4">
              <li className="cursor-pointer flex gap-x-4 px-4 pt-4">
